...
<body>
  <div class="form-group" id="graficas-informativas-alumno" name="graficas-informativas-alumno">
    ...
    <div class="card" id="info-alumno-datos-clase" name="info-alumno-datos-clase">
      ...
      <div class="card-body">
        <p class="card-text" id="info-alumno-clase" name="info-alumno-clase"><b>Clase:</b> LABORATORIO DE CONTROL SECUENCIAL</p>
        <p class="card-text" id="info-alumno-materia" name="info-alumno-materia"><b>Materia:</b> CONTROL SECUENCIAL</p>
        <p class="card-text" id="info-alumno-seccion" name="info-alumno-seccion"><b>Sección:</b> D01</p>
        <p class="card-text" id="info-alumno-ciclo" name="info-alumno-ciclo"><b>Ciclo:</b> 2019 B</p>
        <p class="card-text" id="info-alumno-claveAcceso" name="info-alumno-claveAcceso"><b>Clave de acceso:</b> vtdVjgoSc7</p>
    ...
    <div class="card" id="info-alumno-datos-alumno" name="info-alumno-datos-alumno">
      ...
      <div class="card-body">
        <p class="card-text" id="info-alumno-nombre-alumno" name="info-alumno-nombre-alumno"><b>Nombre:</b> Castillo Serrano Cristian Michell</p>
        <p class="card-text" id="info-alumno-codigo-alumno" name="info-alumno-codigo-alumno"><b>Código:</b> A215861738</p>
