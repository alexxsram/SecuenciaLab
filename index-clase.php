                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <?php if($estado == 'INICIO_SESION_PROFESOR' || $estado == 'INICIO_SESION_ADMIN') { ?>
        ...
        <div class="container h-100">
            ...
            <div class="jumbotron">
                <div class="container">
                    ...
                    <?php if($estado == 'INICIO_SESION_ADMIN') { ?>
                    ...
                    <?php } else if($estado == 'INICIO_SESION_PROFESOR') { ?>
                        <p class="lead text-justify">
            ...
            <div class="row h-100" style="margin-top: -1%;">
                ...
                foreach ($clases as $clase) {
                    ...
                    WHERE Clase_claveAcceso= :Clase_claveAcceso';
                    $resultado = $baseDatos->prepare($sql);
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text text-center" style="font-size: 12.5px;">
                                ...
                                <?php } else if($estado == 'INICIO_SESION_ADMIN') { ?>
                                    <b> Alumnos: </b> <?php echo $numeroAlumnos; ?> <br>
