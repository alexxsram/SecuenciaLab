...
try {
    ...
    $pdf->SetHeaderData($ln = '', $lw = 0, $ht = '', $hs = '<div style="text-align: center;"> Reporte de práctica </div>', $tc = array(0, 0, 0), $lc = array(0, 0, 0));
    ...
    if($numRowClase != 0) {
        ...
        WHERE P.Clase_claveAcceso = :cca AND CU.AlumnoUsuario_codigoAlumno = :auca AND P.idPractica = :idPrac AND P.eliminado != true';
        $resultado = $baseDatos->prepare($sql);
        $array = array(
        ...
        foreach ($registros as $registro) {
            ...
            $html .= '<table border="1" cellspacing="3" cellpadding="4">
                ...
                <thead>
                    <tr>
                        <th colspan="12" style="text-align: center; background-color: #1C6EA4; color: #FFFFFF;"> <b>' . $registro->nombre . ' </b> </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td colspan="2" style="vertical-align:bottom; text-align: center; background-color: #555555; color: #FFFFFF;"> <b> Calificación </b> </td>
                        <td colspan="10" style="text-align: justify; background-color: #D0E4F5;">' . $registro->califiacion . '</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="vertical-align:bottom; text-align: center; background-color: #555555; color: #FFFFFF;"> <b> Respuesta pregunta 1 </b> </td>
                        <td colspan="10" style="text-align: justify; background-color: #D0E4F5;">' . $registro->respuestaPregunta1 . '</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="vertical-align:bottom; text-align: center; background-color: #555555; color: #FFFFFF;"> <b> Respuesta pregunta 2 </b> </td>
                        <td colspan="10" style="text-align: justify; background-color: #D0E4F5;">' . $registro->respuestaPregunta2 . '</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="vertical-align:bottom; text-align: center; background-color: #555555; color: #FFFFFF;"> <b> Respuesta pregunta 3 </b> </td>
                        <td colspan="10" style="text-align: justify; background-color: #D0E4F5;">' . $registro->respuestaPregunta3 . '</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="vertical-align:bottom; text-align: center; background-color: #555555; color: #FFFFFF;"> <b> Conclusion </b> </td>
                        <td colspan="10" style="text-align: justify; background-color: #D0E4F5;">' . $registro->conclusion . '</td>
                    </tr>
                    <tr>
                        <td colspan="2" style="vertical-align:bottom; text-align: center; background-color: #555555;color: #FFFFFF;"> <b> Diagrama de control </b> </td>
                        <td colspan="10" style="text-align: center; background-color: #D0E4F5;"> <img src="' . $registro->rutaArchivo . '"> </td>
                    </tr>
                </tbody>
            </table>';
        }
        ...
        $pdf->Output('reporte_practica_' . $codigoAlumno . '_' . $nombrePracticaObjetivo . '.pdf', 'I');
