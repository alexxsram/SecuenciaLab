...
<div class="card border-dark mb-3">
    ...
    <div class="card-body text-dark">
        ...
        <div class="alert alert-light text-justify" role="alert">
            ...
            <button type="button" class="btn btn-sm btn-outline-success btn-block" onclick="descargarArchivo(<?php echo '\'' . $cuestionario->rutaArchivo . '\''; ?> , <?php echo '\'' . $cuestionario->nombreOriginal . '\''; ?> );">
                Descargar archivo <i class="fas fa-file-download"></i>
            </button>
        </div>

        <div class="alert alert-light text-justify" role="alert">
            <h5 class="alert-heading">Reporte práctica</h5>
            <button type="button" class="btn btn-sm btn-outline-dark btn-block" onclick="cargarContenido('../../DOCS/examples/', 'reporte-practica-alumno.php', 'claveAccesoClase=' + <?php echo '\'' . base64_encode($cuestionario->Clase_claveAcceso) . '\''; ?> + '&codigoAlumno='+ <?php echo '\'' . base64_encode($codigoAlumno) . '\''; ?> + '&idPractica='+ <?php echo '\'' . base64_encode($idPractica) . '\''; ?>);">
