      ...
      <div class="jumbotron col-12">
        <div class="container">
          ...
          if(substr($criterioCalificar, 0, 1) != 'A') { // es decir, que si se califica desde las practicas
            ...
            <div class="form-inline">
              ...
              if($numRow != 0) {
                ...
                <div class="form-group">
                  ...
                  <select class="custom-select mr-sm-2" id="alumnoEntregado" name="alumnoEntregado" onchange="muestraDetalle('', 'cargar-detalle-entrega.php', 'codigoAlumno=' + this.value + '&idPractica=' + <?php echo $practica->idPractica; ?>, 'detalleEntrega');">
                    ...
                    <?php foreach ($entregados as $entregado) {
                      ...
                      $resultado = $baseDatos->prepare($sql);
                      $resultado->bindValue(':pip', $practica->idPractica);
                      $resultado->bindValue(':idAlumno', $entregado->codigoAlumno);
                      $resultado->execute();
            ...
            <?php } else { // es decir, que si se califica desde la lista de alumnos
