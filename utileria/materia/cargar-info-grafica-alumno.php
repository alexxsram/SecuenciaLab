  ...
  if($numRow != 0){
    ...
    (SELECT idCuestionario
      ...
      (SELECT practica.idPractica
        ...
        id=\"info-alumno-nombre-alumno\"
        name=\"info-alumno-nombre-alumno\">
        <b>Nombre:</b>" . " "
        ...
        echo "<p class=\"card-text\"
        id=\"info-alumno-codigo-alumno\"
        name=\"info-alumno-codigo-alumno\">
        <b>Código:</b> $alumno->codigoAlumno </p>";

        echo "<p class=\"card-text\"
        id=\"info-alumno-promedio-alumno\"
        name=\"info-alumno-promedio-alumno\">
        <b>Promedio:</b> $promedioAlumno</p>";
      }else{
        echo "<p class=\"card-text\"
        id=\"info-alumno-promedio-alumno\"
        name=\"info-alumno-promedio-alumno\">
        <b>Error:</b> El alumno no se encuentra registrado en el sistema.</p>";
      }
