                        ...
                        <?php if($estado == 'INICIO_SESION_PROFESOR') { ?>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="gedf-drop1">
                              ...
                              <button class="dropdown-item" data-toggle="modal"  data-target="#modalEditarAnuncio" data-idanuncio="<?php echo $anuncio->idAnuncio; ?>"
              ...
              if($numRow == 0) {
                ...
                <div class="card-columns">
                  ...
                  foreach ($practicas as $practica) {
                    ...
                    $resultado->bindValue(':alumCod', $codigo);
                    $resultado->execute();
                    ...
                    if($numRowCuestionario == 1) {
                      ...
                      $sql = "SELECT * FROM evaluacion WHERE Cuestionario_idCuestionario = :cuesIdCues";
                      $resultado = $baseDatos->prepare($sql);
                      $resultado->bindValue(':cuesIdCues', $cuestionario->idCuestionario);
                      $resultado->execute();
                    ...
                    if($actividadEntregada && date('Y-m-d') < $practica->fechaLimite){
                      $colorBorde = "warning";
                      $botonEntregarHabilitado = "";
                    ...
                    else if(date('Y-m-d') > $practica->fechaLimite){
                    ...
                    echo "<div class=\"card border-$colorBorde mb-3\">";
                    echo "<div class=\"card-header bg-transparent border-$colorBorde\">";
                    echo "<div class=\"form-group\" style=\"text-align: center;\">";
                    echo "<span class=\"badge badge-$colorBorde\" style=\"text-align: center;\">$estadoActidad</span>";
                    echo "</div>";
                    echo "</div>";
                    ...
                    echo "</p>";
                    echo "<button type=\"button\" class=\"btn btn-sm btn-outline-$colorBorde\" data-toggle=\"modal\" $botonEntregarHabilitado data-target=\"#modalEntregaPractica\"";
                    echo "data-idpractica=\"$practica->idPractica\"";
                    echo "data-nombre=\"$practica->nombre\"";
                    echo "data-descripcion=\"$practica->descripcion\"";
                    echo "data-fechalimite=\"$practica->fechaLimite\"";
                    echo "data-codigoalumno=\"$codigo\"";
                    echo "data-claveacceso=\"$clase->claveAcceso\">";
                    echo "Entregar <i class=\"fas fa-check-square\"></i>";
                    echo "</button>";
                    echo "</div>";
                    echo "<div class=\"card-footer border-$colorBorde\">";
                    echo "<small class=\"text-muted\"><i class=\"fas fa-calendar\"></i> Fecha de entrega: $practica->fechaLimite</small>";
                    echo "</div>";
                    echo "</div>";
                  }
                  echo "</div>";
