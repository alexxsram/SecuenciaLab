...
try {
  ...
  if($numRow != 0){
    ...
    id=\"info-alumno-descripcion-practica\"
    name=\"info-alumno-descripcion-practica\">
    <b>Descripción:</b> $practica->descripcion</p>";
  }else{
    echo "<p class=\"card-text\"
    id=\"info-alumno-descripcion-practica\"
    name=\"info-alumno-descripcion-practica\">
    <b>Descripción:</b> Error. El id de la práctica es invalido.</p>";
  }
